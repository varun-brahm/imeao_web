        ...
        <?= GridView::widget([
            ...
            'columns'=>[
                ...
                [
                    ...
                    'dropdown' => false,
                    'vAlign'=>'middle',
                    'template'=>' {update} {edit_naam} ',
                    'urlCreator' => function($action, $model, $key, $index) {
                        return Url::to(['student-algeheel-'.$action,'studentid'=> $model->student_id]);
                    },
                    ...
                    'buttons' => [
                        'edit_naam' => function ($url, $model, $key) {
                            return Html::a('<span>naam</span>', ['edit-naam', 'student_id' => $model->student_id],
                                [
                                    'role'=>'modal-remote',
                                    'title' => 'Klas ',
