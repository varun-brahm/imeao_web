...
<div class="student-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'columns'=>[
                ...
                [    'class'=>'kartik\grid\ExpandRowColumn',
                    ...
                    'detail'=>function ($model) {
                        return $this->render('student_algeheel_det', ['id'=>$model->ID]);
                    },
                ...
                [
                    ...
                    'urlCreator' => function($action, $model, $key, $index) {
                        return Url::to(['algeheel-'.$action,'id'=>$key]);
                    },
                    'viewOptions'=>['data-pjax'=> 0,'target'=>'_blank','title'=>'Bekijken', 'data-toggle'=>'tooltip', 'class'=>'btn btn-secondary btn-xs'],
            ...
            'toolbar'=> [
                ['content'=>
//                    Html::a('<i class="fas fa-file-excel"></i>', ['student-create'],
//                        ['role' => 'modal-remote', 'title' => 'Nieuwe student', 'class' => 'btn btn-success']).
